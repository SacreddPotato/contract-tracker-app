...
*/
export const checkForUpdates = (options?: RouteQueryOptions): RouteDefinition<'post'> => ({
...
* @route '/api/app/updates/check'
*/
checkForUpdates.post = (options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: checkForUpdates.url(options),
    method: 'post',
})
...
* @route '/api/app/updates/check'
*/
const checkForUpdatesForm = (options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
...
* @route '/api/app/updates/check'
*/
checkForUpdatesForm.post = (options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: checkForUpdates.url(options),
    method: 'post',
})
