...
const Controllers = {
    NativeAppBootedController: Object.assign(
        NativeAppBootedController,
        NativeAppBootedController,
    ),
    DispatchEventFromAppController: Object.assign(
        DispatchEventFromAppController,
        DispatchEventFromAppController,
    ),
    CreateSecurityCookieController: Object.assign(
