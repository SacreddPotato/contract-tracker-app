 ...
 */
const CreateSecurityCookieController = (
 ...
 * @route '/_native/api/cookie'
 */
CreateSecurityCookieController.get = (
    options?: RouteQueryOptions,
): RouteDefinition<'get'> => ({
    url: CreateSecurityCookieController.url(options),
    method: 'get',
 ...
 * @route '/_native/api/cookie'
 */
CreateSecurityCookieController.head = (
    options?: RouteQueryOptions,
 ...
 * @route '/_native/api/cookie'
 */
const CreateSecurityCookieControllerForm = (
    options?: RouteQueryOptions,
 ...
 * @route '/_native/api/cookie'
 */
CreateSecurityCookieControllerForm.get = (
    options?: RouteQueryOptions,
): RouteFormDefinition<'get'> => ({
    action: CreateSecurityCookieController.url(options),
    method: 'get',
 ...
 * @route '/_native/api/cookie'
 */
CreateSecurityCookieControllerForm.head = (
    options?: RouteQueryOptions,
): RouteFormDefinition<'get'> => ({
