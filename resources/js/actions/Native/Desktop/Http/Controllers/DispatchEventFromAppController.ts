 ...
 */
const DispatchEventFromAppController = (
 ...
 * @route '/_native/api/events'
 */
DispatchEventFromAppController.post = (
    options?: RouteQueryOptions,
): RouteDefinition<'post'> => ({
    url: DispatchEventFromAppController.url(options),
    method: 'post',
 ...
 * @route '/_native/api/events'
 */
const DispatchEventFromAppControllerForm = (
    options?: RouteQueryOptions,
 ...
 * @route '/_native/api/events'
 */
DispatchEventFromAppControllerForm.post = (
    options?: RouteQueryOptions,
): RouteFormDefinition<'post'> => ({
    action: DispatchEventFromAppController.url(options),
    method: 'post',
